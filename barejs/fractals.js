...
//        console.info("rendering at t= " + tframe)
    ...
    function generateImage() {
        ...
        console.info("iterating over " + imageh + " x " + imagew + " pixels")
        var start = Date.now();
        ...
        console.info("computation took" + elapsed + " millis");
    }

    // Calculate the color of a specific pixel
    function iterate(x, y, maxiterations) {
        var startIteration = Date.now();
        ...
        var endIter = Date.now();
        var elapsedIter = endIter - startIteration;
        if (x % 100 == 0 && y % 100 == 0)
          console.info("iteration took " + elapsedIter + " millis");
